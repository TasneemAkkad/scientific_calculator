...
// 
public class testC extends JFrame implements ActionListener, KeyListener {
 
    //declare all panel sections
    JMenuBar menuBar;
    ...
    // declare the black screen
    JTextField textField;
 
    // buttons in the Jframe
    ...
    private void autoAddOrRemove(String button) {
        ...
        if (!textField.getText().isEmpty()) {
            ...
            switch (button) {
                ...
                //if the last character is one of these add x
                case "symbol":
                ...
                //when user press number after pi or e its going to add x 
                case "number":
                    switch (lastCharacter) {
                        case 'e':
                        case 'π':
                ...
                // in this case the user wont be able to put more than one operation
                case "operand":
                    switch (lastCharacter) {
                        case '+':
                        case '-':
                ...
                //making sure that there is not more than to . beside each other
                case "point":
                    switch (lastCharacter) {
                        case '+':
                        case '-':
    ...
    // adding numbers symbols and functions to the black screen
    ...
    //this function works when we press = , its going to call the calculate function
    ...
    // delete one step on the black screen when press ->
    ...
    //delete every thing on the black screen 
    ...
    private void createAndShowGUI() {
        ...
        // creating the black screen and historyScroller
        historyText = new JTextArea();
        historyScroller = new JScrollPane(historyText);
 
        // specify position and size of item
        ...
        // specify the color of the items in the panel
        ...
        // connect the buttons to the function to work
        ...
        // adding every thing to the Jframe
        add(panel);
        add(historyScroller);
        setJMenuBar(menuBar);
    ...
    // connect the button with the function to calculate what ever we press
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //  coping what on the black screen
        ...
        // paste what ever we want on the black screen
    ...
    // calling the right function when press on a specific key from keyboard
    @Override
    ...
    // Override KeyListener (interface)
    @Override
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                //creating an object from testC class so we can call the createAndShowGUI() function
